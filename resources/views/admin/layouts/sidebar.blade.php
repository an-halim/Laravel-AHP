	...
	<div class="sidebar-scroll">
		<nav>
			<ul class="nav">
				...
				@if (auth()->user()->role=='Admin')
				<li>
					<a href="#datamaster" data-toggle="collapse" class="collapsed"><i class="fa fa-file"></i> <span>Data Master</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
					<div id="datamaster" class="collapse ">
						<ul class="nav">
							<li><a href="/admin/user"><i class="lnr lnr-user"></i> <span>User</span></a></li>
							<li><a href="/admin/rumah"><i class="lnr lnr-map-marker"></i> <span>Rice Cooker</span></a></li>
				...
				@endif
				<li>
					<a href="#ahp" data-toggle="collapse" class="collapsed"><i class="fa fa-line-chart"></i> <span>AHP</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
					<div id="ahp" class="collapse ">
						<ul class="nav">
							@if (auth()->user()->role=='Admin')
