...
class AhpController extends Controller
{
    ...
    public function indexbobot()
    {
        ...
        return view('dashboard.bobot.bobot', compact('criteria'));
    }
    ...
    public function indexbobotsub()
    {
        ...
        return view('dashboard.bobot-sub.bobot-sub', compact('subCriteria'));
    }
    ...
    public function tampilalternative()
    {
        ...
        return view('dashboard.ahp-alternatif.ahp-alternatif', [
    ...
    public function postbobot(Request $request)
    {
        ...
        // Kirim hasil ke view
        return view('dashboard.matrix1.matrix1', [
            'matrix' => $matrix,
    ...
    public function postmatriks(Request $request)
    {
        ...
        return view('dashboard.matrix2.matrix2', [
            'k1' => $k1,
            'k2' => $k2,
            'k3' => $k3,
            'k4' => $k4,
    ...
    public function postmatriks2(Request $request)
    {
        ...
        return view('dashboard.matrix3.matrix3', [
            'k1' => $k1,
            'k2' => $k2,
            'k3' => $k3,
            'k4' => $k4,
    ...
    public function cekkonsistensi(Request $request)
    {
        ...
        return view('dashboard.consictensy.consictensy', [
            'k1' => $k1,
            'k2' => $k2,
            'k3' => $k3,
            'k4' => $k4,
    ...
    public function postmatriksnew(Request $request)
    {
        ...
        return view('dashboard.matrix2new.matrix2new', [
            'matrix' => $matrix,
            'normalizedMatrix' => $normalizedMatrix,
    ...
    public function postmatriks2new(Request $request)
    {
        ...
        return view('dashboard.bobot-sub.bobot-sub', [
        ...
        // return view('dashboard.matrix3new.matrix3new', [
        //     'weightedMatrix' => $weightedMatrix,
        //     'lambdaMax' => $lambdaMax,
        //     'ci' => $ci,
        //     'cr' => $cr,
    ...
    {
        $criteriaWeightedMatrix = $request->input('weightedMatrix');
        // Ambil data comparison dari request atau preset
        $subComparison = $request->input('subComparison', []);

        dd($criteriaWeightedMatrix, $subComparison);
        ...
        // Tampilkan hasil
        return view('dashboard.consictensy-sub.consictensy-sub', [
            'results' => $results,
        ]);
    }
    ...
    public function postSubCriterias(Request $request)
    {
        ...
        foreach ($subComparison as $criteriaName => $comparisons) {
            ...
            // Simpan hasil untuk setiap kriteria
            $results[$criteriaName] = [
                'criteriaWeightedMatrix' => $criteriaWeightedMatrix,
                'matrix' => $matrix,
                'normalizedMatrix' => $normalizedMatrix,
                'priorityVector' => $priorityVector,
                'weightedMatrix' => $weightedMatrix,
    ...
    public function calculateRecommendation(Request $request)
    {
        ...
        $criteriaWeights = $request->input('criteriaWeightedMatrix');
    ...
    {
        // Ambil data dari request
        $criteriaWeights = $request->input('criteriaWeightedMatrix'); // Bobot kriteria utama
